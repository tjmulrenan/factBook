...
def enhance_facts_with_openai(batch):
    prompt = (
        ...
        "- When possible, connect the fact to something a child might care about (like pets, school, family, fairness, sports, art, nature, science, food, internet, games, creativity, music, exploring, or friendship).\n"
        "- But don’t force it! If it doesn’t relate to a kid’s world, just make it engaging in a different way (like telling a mini story, painting a vivid scene, or using humor).\n"
