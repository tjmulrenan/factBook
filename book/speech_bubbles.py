...
from config import FONTS_DIR, QUOTES_JSON, JOKES_JSON, OVERLAYS_DIR, BOOKS_DIR, FINAL_OUTPUT_DIR, FINAL_FACTS_DIR
...
# Font
FONT_PATH = str(FONTS_DIR / "Baloo2-Bold.ttf")
FONT_NAME = "Baloo2Bold"  # No spaces — required by PyMuPDF

# Image assets
IMAGE_MAP = {
    "bonus_fact":        str(OVERLAYS_DIR / "bonusFact.png"),
    "follow_up_question":str(OVERLAYS_DIR / "followUpQuestion.png"),
    "quote":             str(OVERLAYS_DIR / "quote.png"),
    "joke":              str(OVERLAYS_DIR / "joke.png"),
}
...
if __name__ == "__main__":
    ...
    FACTS_ROOT = str(FINAL_FACTS_DIR)
    ...
    candidates = [
        ...
        str(BOOKS_DIR / "finishedBook.pdf"),
    ]
